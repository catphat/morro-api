...
SELECT poll_timestamp                                                                       as time,
       (SELECT id
        ...
        WHERE r.id = regional_market_item.region_id
          ...
          AND tmp_i.enhancement_level_min = regional_market_item.enhancement_level) as market_item_id,
       base_price,
       current_stock,
       total_trades,
       last_sale_timestamp,
...
SELECT poll_timestamp                                                                       as time,
       (SELECT id
        ...
        WHERE region_fk = regional_market_item.region_id
          ...
          AND enhancement_level_min = regional_market_item.enhancement_level) as market_item_id,
