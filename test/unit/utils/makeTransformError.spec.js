...
describe('utils/makeTransformError', () => {
  ...
  context('error has a config', () => {
    ...
    context('error has no config', () => {
      context('error has a response', () => {
        it('throws a ResponseError', () => expect(() => transformError({
          message,
          response: {
            status,
            data,
      ...
      context('error has a request', () => {
        it('throws a RequestError', () => expect(() => transformError({ message, request })).to.throw(
          RequestError,
          message,
        ));
      });
    ...
    context('just an error', () => {
      it('throws a RequestError', () => expect(() => transformError({ message })).to.throw(Error, message));
    });
  });
});
